    ...
    if t_response:
        ...
        if "formats" in response_json:
            for formats in response_json["formats"]:
                ...
                if "DASH" in (format_string or "").upper():
                    continue
                ...
                if format_string is not None and not "audio only" in format_string:
                    ikeyboard = [
                        InlineKeyboardButton(
                            "📁 " + (format_string or "unknown") + " " + (format_ext or "bin") + " " + humanbytes(size) + " ",
        ...
        # yt-dlp returned no JSON; show a useful error instead of a broken fallback.
        inline_keyboard = []
        cb_string_file = "{}={}={}".format(
            "file", "LFO", "NONE")
        cb_string_video = "{}={}={}".format(
